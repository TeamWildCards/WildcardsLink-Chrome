...
MIDI_RESPONSE[REPORT_VERSION] = function(board) {
    ...
    //for (var i = 0; i < 16; i++) {
    //    board.sp.write([REPORT_DIGITAL | i, 0]);
    //    board.sp.write([REPORT_ANALOG | i, 0]);
    //}
...
SYSEX_RESPONSE[CAPABILITY_RESPONSE] = function(board) {
    ...
    console.log("doing capability response")
...
SYSEX_RESPONSE[STRING_DATA] = function(board) {
	//TODO: May need to handle this differently, removed a buffer operation function, maybe this?
/**
      var str = "",
        data,
        len = msg.length;
...
**/
    //board.emit('string', board.currentBuffer.slice(2, -1);
};
/**
...
/*
Board.prototype.initialize = async function() {
